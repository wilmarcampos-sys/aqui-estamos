...
function amzIcon(){ return '<svg class="ic amzlogo" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 11c3.1 2.8 7.1 4.2 10.8 4.2 3 0 5.9-.8 8.5-2.5"/><path d="M18.3 14.4c1.7-1 3.5-1.2 3.8-.9.3.4-.2 2.3-1.3 3.3"/></svg>'; }
